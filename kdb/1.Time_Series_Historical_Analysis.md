...
### SQL Support 
SQL querying is supported in the latest version of kdb+, making it easier to work with familiar SQL syntax directly alongside q. SQL can be invoked in a few different ways:
